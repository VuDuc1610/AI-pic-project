...
import { preview,example } from "../assets";
...
const CreatePost = () => {
  ...
  const generateImage = async () => {
    if (form.prompt) {
      try {
        ...
        const response = await fetch("https://ai-pic-project.onrender.com/api/v1/dalle", {
          method: "POST",
          headers: {
  ...
  // const generateImageFake = () => {
  //   if (form.prompt) {
  //     try {
  //       setGeneratingImg(true);

  //       setForm({ ...form, photo: example});
  //     } catch (error) {
  //       alert(error);
  //       console.log(error);
  //     } finally {
